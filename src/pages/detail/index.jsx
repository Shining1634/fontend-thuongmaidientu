...
import {
  fetchAllProductToCategoryLienQuan,
  fetchSPDetail,
...
const DetailProduct = () => {
  ...
  const fetchProductDetail = async () => {
    if (!dataDetailSP) {
      // Chỉ fetch khi dataDetailSP chưa có dữ liệu
  ...
  const images =
    dataDetailSP?.ImageSlider?.map((imageName) => ({
      original: imageName,
      thumbnail: imageName,
  ...
  const soLuongTonKho = dataDetailSP?.sizes.reduce(
              ...
              <div className="col-xl-8 col-lg-8 col-md-12">
                <div className="product-details-container">
                  <div className="rts-product-details-section">
                    <h1 className="product-title text-center mb-4">
                      {dataDetailSP?.TenSP}
                    </h1>
                            ...
                            <div className="product-info">
                                  ...
                                  <Col md={16} xs={24}>
                                    <div className="option-group">
                                      ...
                                      <Select
                                        ...
                                        options={dataDetailSP?.sizes.map(
                                          (item) => ({
                                            value: item._id,
                                            label: item.size,
                                          })
                                  ...
                                  <Col md={8} xs={24}>
                                    <div className="option-group">
                                      ...
                                      <InputNumber
                                        ...
                                        className="w-100 modern-input-number"
                                        style={{ padding: "5px" }}
                                      />
                                    </div>
                                  </Col>
                              ...
                              <div className="product-meta text-muted">
                                <p>
                                  Thương hiệu:{" "}
                                  <strong>
                                    {dataDetailSP?.IdHangSX.TenHangSX}
                                  </strong>
                                </p>
                                <p>
                                  Loại sản phẩm:{" "}
                                  {dataDetailSP?.IdLoaiSP?.map(
                                    (item, index) => (
                                      <span key={index}>
                                        {item.TenLoaiSP}
                                        {index <
                                        dataDetailSP.IdLoaiSP.length - 1
                                          ? ", "
                                          : ""}
                                      </span>
                                    )
                                ...
                                <p>
                                  Giảm giá:{" "}
                                  <strong>{dataDetailSP?.GiamGiaSP}%</strong>
                                </p>
                                <p>
                                  Số lượng đã bán:{" "}
                                  <strong>{dataDetailSP?.SoLuongBan}</strong>
                                </p>
                              </div>
                              ...
                              <div className="share-options d-flex gap-3 mt-4">
                                ...
                                >
                                  <i className="fa-regular fa-heart me-2" /> Yêu
                                  thích
                                </button>
                                <button className="btn btn-outline-secondary">
                                  <i className="fa-solid fa-share me-2" /> Chia
                                  sẻ
                                </button>
                                <button className="btn btn-outline-secondary">
                                  <i className="fa-light fa-code-compare me-2" />{" "}
                                  So sánh
                                </button>
                              </div>
                            </div>
                  ...
                  <div className="product-tabs mt-5">
                    <ul
                      className="nav nav-tabs modern-tabs"
                      id="myTab"
                      role="tablist"
                    >
                    ...
                    <div className="tab-content mt-4" id="myTabContent">
                      ...
                      >
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: dataDetailSP?.MoTaChiTiet,
                          }}
                          style={{ fontSize: "16px" }}
                        />
                      </div>
                      ...
                      >
                        <div className="tab-content-inner">
                          ...
                          <p className="mt-3">
                            <strong>Trả hàng/Hủy hàng:</strong> Không áp dụng
                            đổi hàng đã giao. Nếu có vấn đề về chất lượng hoặc
                            số lượng, khách hàng có thể trả hàng khi có mặt
                            người giao hàng.
                          </p>
                          <p>
                            <strong>Lưu ý:</strong> Thời gian giao hàng có thể
                            thay đổi tùy theo tình trạng kho.
                          </p>
                          <div
                            className="youtube-video mt-3"
                            dangerouslySetInnerHTML={{
                              __html: dataDetailSP?.urlYoutube,
                            }}
                          />
                        </div>
                      </div>
                      ...
                      >
                        <div
                          className="single-tab-content-shop-details"
                          id="review-tab-pane"
                        >
                                ...
                                <Row gutter={[35, 20]}>
                                  ...
                                  >
                                    <span>
                                      ...
                                      />{" "}
                                      &nbsp;&nbsp;&nbsp;&nbsp;
                                      <span className="txt-count-sao">
                                        {starCount[5] || 0} &nbsp; Luợt đánh giá
                                      </span>
                                    </span>{" "}
                                    <br />
                                    <span>
                                      ...
                                      <Row gutter={[10, 5]}>
                                        <Col span={24} md={24} sm={24} xs={24}>
                                          <Form.Item
                                            ...
                                            ]} // Bắt buộc người dùng phải chọn đánh giá sao
                                          >
                                            <Rate
                                              tooltips={tooltips}
                                              className="ratee"
                ...
                <div className="sidebar-sticky">
                  <div className="offers-section mb-4 p-4 bg-white shadow-sm rounded">
                    ...
                    <div className="offer-item d-flex mb-3">
                      ...
                      <p className="mb-0">
                        Giảm 5% cho đơn hàng đầu tiên qua UPI Ekomart.
                      </p>
                    </div>
                    <div className="offer-item d-flex mb-3">
                      <img src={svg02} alt="icon" className="me-3" width="40" />
                      <p className="mb-0">
                        Giảm 500K cho đơn từ 9M khi trả góp bằng thẻ Citi.
                      </p>
                    </div>
                    <div className="offer-item d-flex">
                      <img src={svg03} alt="icon" className="me-3" width="40" />
                      <p className="mb-0">
                        Miễn phí vận chuyển cho đơn trên 1.000.000đ.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="product-card cellphone-style">
                    ...
                    <div className="product-image-wrapper">
                      <a
                        style={{ fontSize: "14px" }}
                        onClick={() =>
                          handleRedirectLayIdDeXemDetailPageUrl(item)
                        }
                        className="thumbnail"
                      >
                        <img
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 col-12">
              ...
              <div className="single-short-service-area-start">
                ...
                <div className="information">
                  ...
                  <p className="disc">
                    Chúng tôi đã chuẩn bị các mức giảm giá đặc biệt cho các sản
                    phẩm trong cửa hàng.
                  </p>
                </div>
              </div>
