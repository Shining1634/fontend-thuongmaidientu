            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="bwtween-area-header-top header-top-style-four">
                  ...
                  {/* <p class="marquee-text">Chào mừng bạn {user.fullName} đến với&nbsp;WebShop DUy Khang!</p> */}
                  {!isAuthenticated ?
                    <>
                    ...
                    :
                    <>
                      <p class="marquee-text">Chào mừng bạn {user.fullName} đến với&nbsp;WebShop linh kiện điện tử! &nbsp;&nbsp;
